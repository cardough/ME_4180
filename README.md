...
3. Open a git bash terminal in that folder (can use an IDE or on Windows, right click in the background of the folder and select "open git bash terminal"). Once you have it open, run:
